...
const BROKER_ATTACHMENT_DOMAINS = [
  // ICICIdirect. Added from the /admin/ai-usage report: it was reaching the AI
  // layer with its mail split across 3 categories (55% agreement) — the
  // statement-vs-market-update split this list exists for.
  "icicisecurities.com",
  "zerodha.com",
  "groww.in",
  "upstox.com",
