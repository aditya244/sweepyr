...
`
  // No "reason" field requested. It used to be — a one-sentence explanation
  // per email — but nothing persisted or displayed it (process/route.js only
  // keeps category/confidence/classificationSource), so it was output tokens
  // paid on every AI call for nothing. If a "why was this classified?" UI is
  // ever built, add it back here and store it on the Email doc.
